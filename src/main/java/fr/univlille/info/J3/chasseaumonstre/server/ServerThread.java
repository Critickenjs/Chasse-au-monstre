...
/**
 * Thread du serveur permettant de traiter les requêtes des 2 clients
 * continuellement durant la partie
 * 
 * @autor Anas Ouhdda
 * @autor Atilla Tas
...
public class ServerThread extends Thread {
     ...
     * - Attend de reçevoir une réponse du client. Après que le joueur ait joué sur
     * tel tour il envoie le nouveau modèle au serveur pour que le thread
     * correspondant reçoive le modèle et le renvoie à l'autre client pour qu'il se
     * synchronise au niveau du modèle.
     * - Si on reçoit un String à la place d'un modèle cela veut dire que le client
     * envoie un message pour informer l'autre client qu'il a gagné
     */
    @Override
    public void run() {
        Object obj;
